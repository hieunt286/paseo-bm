...
- **Quyền:** Worker và Reviewer chạy bằng quyền của chính người dùng trong workspace đó. Worker chạy ở chế độ không hỏi quyền của provider; Reviewer chạy ở chế độ tự động không mở toàn quyền hay quyền mạng (REQ-026c). Manager không tự phê duyệt yêu cầu quyền. Rủi ro đã biết: ranh giới an toàn của Worker chỉ còn nằm trong chỉ dẫn vai trò.
