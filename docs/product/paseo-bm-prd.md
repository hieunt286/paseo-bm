...
| M-10 | Thời gian từ lúc người dùng giao yêu cầu tới lúc Beads Worker xuất hiện trong workspace | ≤ 5 giây | Đo trong demo và trong test với Paseo SDK giả lập |
...
- **Quyền:** Worker và Reviewer chạy bằng quyền của chính người dùng trong workspace đó. Không nâng quyền, không tự phê duyệt các yêu cầu quyền, không tắt cơ chế hỏi phê duyệt của Paseo.
