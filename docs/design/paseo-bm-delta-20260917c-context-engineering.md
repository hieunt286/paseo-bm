...
- **Mode:** `worker.md` không còn dạy chọn mode cho Reviewer; `manager.md` có đúng một câu trỏ tới dòng *Runtime facts* và không còn `inspect_provider`.
