...
| Tài liệu gốc | [Technical Design](./paseo-bm.md) (payload plugin, vai trò, dừng việc); [Technical Design Dashboard](./paseo-bm-dashboard.md) §3.3, §4, §6 và RPC `workspaces.overview`; [PRD](../product/paseo-bm-prd.md) REQ-026f; [PRD Dashboard](../product/paseo-bm-dashboard-prd.md) REQ-041, REQ-057 |
| Status | **Applied** — 2026-09-17. Owner chốt Q23–Q28 cùng ngày; WP-236 → WP-241 đã đóng. Phần lệch so với bản Accepted ghi ở §11 |
