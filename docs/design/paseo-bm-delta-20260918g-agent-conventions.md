...
| Tài liệu gốc | [Technical Design](./paseo-bm.md) (Active); [delta 20260916-chat-cards](./paseo-bm-delta-20260916-chat-cards.md) §4 (thẻ, `chat.peers`); [delta 20260917c-context-engineering](./paseo-bm-delta-20260917c-context-engineering.md) §4.6 (Runtime facts); [delta 20260918-manager-mode-model-metrics](./paseo-bm-delta-20260918-manager-mode-model-metrics.md) §4.1 (`bm.modeSet`, Paseo CLI) — **không sửa tại chỗ** |
...
| Status | **Active** — cổng `design-ready` **PASS 2026-09-18** (review `b2` pass sau một lần sửa ở §4.7); owner đã chốt Q6–Q10 (§9) |
| Owner | hieu.nt10 |
