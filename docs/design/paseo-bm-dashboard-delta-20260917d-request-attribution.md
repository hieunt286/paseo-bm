...
| Tài liệu gốc | [Technical Design Dashboard](./paseo-bm-dashboard.md) §3.3 (chống trùng), §4 bước 2 (lượt Manager không nêu request); [PRD Dashboard](../product/paseo-bm-dashboard-prd.md) REQ-041, REQ-057 |
| Status | **Accepted** — lỗi do owner báo ngày 2026-09-17; không có quyết định sản phẩm nào cần chốt |
