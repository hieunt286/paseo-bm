...
| Status | **Applied** — mọi WP đóng ngày 2026-09-17, nghiệm thu đạt ([biên bản](../operations/paseo-bm-workflow-skills-run-20260917.md)) |
...
- **Exit condition:**
  ...
  7. Có biên bản `docs/operations/paseo-bm-workflow-skills-run-20260917.md`.
