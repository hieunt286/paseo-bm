...
| Status | **Applied** — sáu bead đóng ngày 2026-09-17 |
...
- **Phạm vi:** `test/roles-content.test.ts`, `docs/design/paseo-bm.md` (errata §2.6), `docs/design/paseo-bm-delta-20260917-workflow-skills.md` (một dòng đầu), `README.md` nếu có trích luật theo câu chữ, `docs/operations/paseo-bm-workflow-skills-run-20260917.md` (mục mới), delta + plan này.
