...
| Ghi chú phát hành | [`paseo-bm-release-notes-0.3.0.md`](../../releases/paseo-bm-release-notes-0.3.0.md) — body của GitHub Release |
| Quy trình | [release runbook](../../operations/paseo-bm-release-runbook.md) **§4** (mục mới cho bản ổn định, viết trong chính phase này) |
