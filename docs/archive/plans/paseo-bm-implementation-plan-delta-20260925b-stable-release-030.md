...
| Ghi chú phát hành | [`paseo-bm-release-notes-0.3.0.md`](../../releases/paseo-bm-release-notes-0.3.0.md) — dùng làm `--notes-file` của GitHub Release |
...
- **Outcome**: bản ghi lần chạy `docs/archive/operations/paseo-bm-release-run-20260925.md`; đồ thị bead sạch.
