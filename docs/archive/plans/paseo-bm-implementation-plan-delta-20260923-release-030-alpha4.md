...
- **Trong phạm vi:**
  - errata cho `docs/releases/paseo-bm-release-notes-0.3.0-alpha.4.md` (đường lùi, bản vá nút Beads, nói rõ bản này gộp);
...
- **Ngoài phạm vi (dễ tưởng là trong):**
  ...
  - **`docs/archive/plans/paseo-bm-implementation-plan-v2.md`** và ba tài liệu delta 20260921 — không sửa nội dung, chỉ thêm một dòng revision trỏ tới delta này khi Applied.
...
- **Phạm vi:** `git tag v0.3.0-alpha.4`, `git push origin v0.3.0-alpha.4`, `gh release create v0.3.0-alpha.4 --prerelease --notes-file docs/releases/paseo-bm-release-notes-0.3.0-alpha.4.md`, theo dõi workflow tới hết `Verify published version`.
