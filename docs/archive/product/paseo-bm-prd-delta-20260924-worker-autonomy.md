...
| PRD gốc | [paseo-bm-prd.md](../../product/paseo-bm-prd.md) (Accepted). **Không sửa tại chỗ.** Delta này thay các ý được nêu dưới đây của REQ-022, REQ-024, REQ-026, REQ-036, REQ-037 và REQ-045 |
