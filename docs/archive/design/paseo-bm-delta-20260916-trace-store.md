...
| Tài liệu gốc | [paseo-bm Technical Design](../../design/paseo-bm.md) (Active) và [paseo-bm PRD](../../product/paseo-bm-prd.md) (Accepted) — **không sửa tại chỗ** |
...
| Owner | hieu.nt10 |
| Created | 2026-09-16 |
| Nguồn | [PRD Dashboard điều phối](../../product/paseo-bm-dashboard-prd.md) REQ-053 → REQ-057 · [Technical Design Dashboard](../../design/paseo-bm-dashboard.md) §3, §5, §14 · [ADR-007](../../adr/ADR-007-dashboard-trace-store.md) (Proposed) |
