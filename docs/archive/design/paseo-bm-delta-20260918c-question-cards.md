...
| Tài liệu gốc | [delta 20260916-chat-cards](./paseo-bm-delta-20260916-chat-cards.md) §4 (thẻ, người gửi/nhận, trả lời); [Technical Design Dashboard](../../design/paseo-bm-dashboard.md) §6 (bộ đọc `BM-REPORT`); [Technical Design](../../design/paseo-bm.md) phần chỉ dẫn vai trò |
