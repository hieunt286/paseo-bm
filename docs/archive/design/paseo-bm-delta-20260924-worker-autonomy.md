...
| Tài liệu gốc | [Technical Design](../../design/paseo-bm.md). Các delta bị thay một phần: [20260917b-simplify-roles](./paseo-bm-delta-20260917b-simplify-roles.md) (bảng mức), [20260917c-context-engineering](./paseo-bm-delta-20260917c-context-engineering.md) (ngân sách), [20260917-workflow-skills](./paseo-bm-delta-20260917-workflow-skills.md) (skill theo mức). **Không sửa tại chỗ** |
