...
3. **Mở quyền công cụ — báo trước rồi bật, kèm thu hẹp theo vai trò** *(sửa 2026-09-15 theo quyết định của owner)*:
   - Trình cài đặt **thông báo rõ rồi bật `daemon.mcp.injectIntoAgents`**. Cảnh báo phải nói thẳng: bật công tắc này nghĩa là **mọi agent trên máy** đều được quyền tạo, nhắc và dừng agent khác, chứ không riêng ba vai trò của paseo-bm. Tương tác thì hỏi đồng ý; không tương tác thì cần cờ `--enable-agent-tools`.
...
4. **Xin đồng ý riêng cho việc mở quyền.** Cho một agent quyền tạo và dừng agent khác là một ranh giới an ninh, nên nó có bước đồng ý riêng, không gộp vào cờ áp dụng chung và không gộp với đồng ý bật plugin.
